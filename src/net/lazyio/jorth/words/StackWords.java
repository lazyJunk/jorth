...
public class StackWords {
    ...
    public static final IWordParser PRINT = (tokens, currentIndex, stack, stackIndex, verbose) -> {
    ...
    public static final IWordParser DUP = (tokens, currentIndex, stack, stackIndex, verbose) -> {
    ...
    public static final IWordParser DROP = (tokens, currentIndex, stack, stackIndex, verbose) -> {
        var pop = stack.get(stackIndex - 1);
    ...
    public static final IWordParser EXIT = (tokens, currentIndex, stack, stackIndex, verbose) -> {
        if (verbose) log("    => Exiting program.\n");
        System.exit(1);
        return new IntPair(currentIndex, stackIndex - 1);
    };
}
